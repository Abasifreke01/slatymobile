...
const AboutClassScreen = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      {/* Button to navigate to WaitingRoomScreen */}
      <TouchableOpacity
        style={styles.greenButton}
        onPress={() => navigation.navigate("WaitingRoom")} // Correct navigation
      >
        <Text style={styles.greenButtonText}>Start Class</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.transparentButton}>
        <Text style={styles.transparentButtonText}>Invite</Text>
      </TouchableOpacity>
    </View>
  );
};
