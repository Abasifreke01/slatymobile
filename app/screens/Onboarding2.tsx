...
const learn = require("../../assets/images/Saly-6.png"); // Learn image
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomContainer}>
        <Text style={styles.bottomText}> Accomplish your  goals</Text>
        
        {/* Spacer between texts */}
        <View style={styles.spacer} />

        <Text style={styles.bottomTextsecond}>
        We make sure hitting that next milestone is possible
        </Text>
